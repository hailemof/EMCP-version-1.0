                  ...
                  <c:forEach items="${mastertransactionlists}" var="transaction">
						<tr>
							...
							<td><a type="button" class="btn btn-success" id="editButton"
								href="/mastertransactionlists/findById?id=${transaction.id}">Evaluate Report</a>
							</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/assignedtransactionlists/update" method="put"> 
            <div class="col-md-6">
           ...
           <div class="form-group" hidden="true">
		    <label for="ddlCountryDetails" class="col-form-label">Assigned Expert: </label>
			    <select class="form-control" id="idexpert" name="assigned_expert_user_id">
			       ...
			       <c:forEach items="${userlist}" var="organization">
