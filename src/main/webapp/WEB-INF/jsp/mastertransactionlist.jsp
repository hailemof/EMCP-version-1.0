                  ...
                  <tr>
                    ...
                    <th><i class="icon_table"></i> Username</th>
                     ...
                     <th><i class="icon_table"></i>Status</th>
                      ...
                      <th><i class ="icon_table"></i> Expert </th>           
                  </tr>
                </thead>
                <tbody>
                  <c:forEach items="${mastertransactionlists}" var="transaction">
						<tr>
					       ...
					       <td>${transaction.assigned_expert_user_id}</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/mastertransactionlists/update" method="put"> 
          ...
          <div class="form-group">
		    <label for="ddlCountryDetails" class="col-form-label">Assigned Expert: </label>
			    <select class="form-control" id="idexpert" name="assigned_expert_user_id" required>
			       <option>-SELECT-</option>
			          
			       <c:forEach items="${userlists}" var="organization">
				      <option value="${organization.id}">${organization.username}
				   </option>
				   </c:forEach>
			    </select>	
          ...
          <div class="form-group">
            <label for="recipient-id" class="col-form-label">Doc name :</label>
            <input type="text" class="form-control" id="idlastmodify" name="doctype"  readonly>
          </div>
          
                          <div class="form-group">
		    <label for="ddlCountryDetails" class="col-form-label">Report Status: </label>
			    <select  id = "idreportstatus"  name = "reportstatus">
