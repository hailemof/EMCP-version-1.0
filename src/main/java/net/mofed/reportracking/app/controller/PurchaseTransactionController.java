...
public class PurchaseTransactionController {
	...
	private UserServiceImpl  uservice;
		...
		@GetMapping("/purchasetransactionlists")
	...
	List<MasterTransaction> transactionlist =  masterTransactionService.getMasterTransaction(keyword);
        ...
        model.addAttribute("purchaseexperts",userlist);
		return  "purchasetransactionlist";		
	}
		@RequestMapping(value="/purchasetransactionlists/update", method= {RequestMethod.PUT, RequestMethod.GET})
		 public String update(MasterTransaction  mastertransaction) {
			 	 	 masterTransactionService.save(mastertransaction);
			 return "redirect:/purchasetransactionlists";
		  }
